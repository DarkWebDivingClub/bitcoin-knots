...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-signetblake2bheight", "Activate the BLAKE2b hardfork at the given height (only for custom signet networks, must have -signetchallenge set; defaults to never). Note that scheduling a height the chain has not reached is not a usable state: see -walletoldsigs.", ArgsManager::ALLOW_ANY | ArgsManager::DISALLOW_NEGATION, OptionsCategory::CHAINPARAMS);
